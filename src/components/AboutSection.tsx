    ...
    <section id="about" className="py-24 md:py-32 bg-background" ref={sectionRef}>
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20 md:mb-32">
          ...
          <h2
            className={`text-3xl md:text-5xl lg:text-6xl font-serif text-foreground leading-tight transition-all duration-700 delay-100 ${
              visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            Alpha X Holding is a private investment office
            <em className="text-accent"> bridging innovation</em> with lasting value.
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          <div
            className={`relative overflow-hidden rounded-sm transition-all duration-700 delay-200 ${
              visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            <img

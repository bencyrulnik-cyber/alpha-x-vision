...
const InvestmentsSection = () => {
  ...
  return <section id="investments" className="py-24 md:py-32 bg-card" ref={sectionRef}>
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="max-w-3xl mb-16 md:mb-24">
          ...
          <h2 className={`text-3xl md:text-5xl font-serif text-foreground leading-tight transition-all duration-700 delay-100 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
          {investmentAreas.map((area, index) => <div key={area.title} className={`bg-card p-8 md:p-10 group hover:bg-secondary/50 transition-all duration-500 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`} style={{
        ...
        <div className={`mt-24 md:mt-32 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`} style={{
        transitionDelay: "900ms"
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-8 md:gap-10 justify-items-center items-center">
            ...
            url: "https://markets.businessinsider.com/news/stocks/prabhav-sharma-highlights-the-90-10-rule-of-investments-showcasing-the-power-law-of-wealth-creation-1035188412"
          }, {
            name: "CEO Weekly",
            logo: ceoWeeklyLogo,
            url: "https://ceoweekly.com/prabhav-sharma-analyzes-potential-bank-collapses/"
          }, {
            name: "Benzinga",
            logo: benzingaLogo,
            url: "https://www.benzinga.com/opinion/23/06/32694882/chatgpt-a-game-changer-for-private-equity-and-venture-capital-investors-featuring-expert-insights-fr"
          }, {
            name: "IB Times",
            logo: ibtimesLogo,
            url: "https://www.ibtimes.sg/navigating-rising-interest-rates-prabhav-sharmas-expert-guidance-investors-70436"
          }, {
            name: "LA Weekly",
            logo: laWeeklyLogo,
            url: "https://www.laweekly.com/investing-in-business-vs-investing-in-people-prabhav-sharmas-holistic-approach/"
          }, {
            name: "Entrepreneur",
            logo: entrepreneurLogo,
            url: "https://www.entrepreneur.com/en-in/news-and-trends/unveiling-the-momentum-investors-flocking-to-us-mid-stage/464113"
          }, {
            name: "Khaleej Times",
            logo: khaleejTimesLogo,
            url: "https://www.khaleejtimes.com/kt-network/private-equity-and-venture-capital-investor-prabhav-sharma-illuminates-the-path-of-risk-management-a"
          }, {
            name: "Apple News",
            logo: appleNewsLogo,
            url: "https://apple.news/A3ppIjnOCSNyAE-WfhqP-Tw"
          }, {
            name: "NY Weekly",
            logo: nyWeeklyLogo,
            url: "https://nyweekly.com/tech/prabhav-sharmas-visionary-understanding-of-ais-global-market-influence-a-butterfly-effect-unleashed/"
          }, {
            name: "Forbes",
            logo: forbesLogo,
            url: "https://forbes.ge/en/prabhav-sharma-s-take-on-how-the-2024-u-s-presidential-race-could-impact-private-equity-and-venture-capital-across-the-globe/"
          }, {
            name: "Gulf News",
            logo: gulfNewsLogo,
            url: "https://gulfnews.com/business/corporate-news/prabhav-sharma-speaks-on-family-office-20-at-adfo-summit-in-abu-dhabi-1.1718788859888"
          }, {
